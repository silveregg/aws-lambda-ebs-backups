...
def lambda_handler(event, context):
    ...
    for region in regions:
        ...
        try:
            ...
            # use the exception message to get the account ID the function
            # executes under
            account_ids.append(
        ...
        message = ("{} snapshots have been cleaned up in "
                   "region {}").format(len(snapshot_response["Snapshots"]), region)
